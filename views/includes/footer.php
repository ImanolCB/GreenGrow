    ...
    <div class="container-fluid mt-4">
        <div class="row p-5 pb-2 bg-dark text-white">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                ...
                <div class="mb-2">
                    <a href="#" class=" text-decoration-none" id="linkFooter">Quienes somos</a>
                </div>
                <div class="mb-2">
                    <a href="#" class=" text-decoration-none" id="linkFooter">Aviso legal</a>
                </div>
                <div class="mb-2">
                    <a href="#" class=" text-decoration-none" id="linkFooter">Donde estamos</a>
                </div>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-3">
                <p class="h5 mb-3">Contactar</p>
                <div class="mb-2">
                    <a href="#" class=" text-decoration-none" id="linkFooter">Centro de soporte</a>
                </div>
                <div class="mb-2">
                    <a href="#" class=" text-decoration-none" id="linkFooter">Atención al cliente</a>
                </div>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-3">
